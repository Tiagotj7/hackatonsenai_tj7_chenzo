CREATE DATABASE senai_chamados; USE senai_chamados;

SET FOREIGN_KEY_CHECKS = 0;
DROP TABLE IF EXISTS ticket_movements;
...
CREATE TABLE tickets (
  ...
  users_nome VARCHAR(150) NOT NULL,
...
INSERT INTO users_admin (nome, usuario, senha_hash, cargo, setor_id, ativo)
VALUES ('Administrador','admin','admin123','Administrador',1,1)
ON DUPLICATE KEY UPDATE senha_hash='admin123', ativo=1;