    ...
    <div class="card">
      <form method="post" action="<?php echo base_url('users/save.php'); ?>" enctype="multipart/form-data" novalidate>
        ...
        <div class="grid cols-2">
          ...
          <div class="form-group"><label>Local do problema</label><input type="text" name="local_problema" placeholder="Sala 101, Lab Informática..." required></div>
        ...
        <div class="form-group"><label>Descrição detalhada</label><textarea name="descricao" required></textarea></div>
        <div class="form-group"><label>Imagem (opcional, até <?php echo max_upload_mb(); ?>MB)</label><input type="file" name="imagem" accept="image/*"></div>
