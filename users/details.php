          ...
          <ul>
            <?php foreach ($movs as $m): ?>
              <li style="margin-bottom:10px;">
                ...
                <small style="color:var(--muted);">em <?php echo e(date('d/m/Y H:i', strtotime($m['created_at']))); ?></small>
                <?php if ($m['admin_nome']): ?>
                  <small style="color:var(--muted);">por <?php echo e($m['admin_nome']); ?></small>
                <?php endif; ?>
                <?php if (!empty($m['resposta'])): ?>
                  <div><?php echo nl2br(e($m['resposta'])); ?></div>
                <?php endif; ?>
              </li>
            <?php endforeach; ?>
          </ul>
