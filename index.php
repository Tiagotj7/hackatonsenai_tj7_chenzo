...
<body>
  ...
  <main>
    <section class="hero">
      <div class="container">
        <div>
          ...
          <div class="mini-muted" style="margin-top:8px;">Sem cadastro para solicitante • Use matrícula para acompanhar</div>
        </div>
        <div class="glass">
          <div class="i-grid cols-3">
            <div class="feature"><div class="icon-circle">⚡</div><div><h4>Registro ágil</h4><p>Campos essenciais e upload de imagem.</p></div></div>
            <div class="feature"><div class="icon-circle">📊</div><div><h4>Dashboard e filtros</h4><p>Por setor, prioridade, período e status.</p></div></div>
            <div class="feature"><div class="icon-circle">🔒</div><div><h4>Acesso seguro</h4><p>Admins com sessão e permissões.</p></div></div>
            <div class="feature"><div class="icon-circle">🧾</div><div><h4>Relatórios</h4><p>Exportação CSV para auditoria.</p></div></div>
            <div class="feature"><div class="icon-circle">🖼️</div><div><h4>Evidências</h4><p>Envio de imagem do problema.</p></div></div>
            <div class="feature"><div class="icon-circle">🌙</div><div><h4>Dark Mode</h4><p>Conforto visual imediato.</p></div></div>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="container">
      ...
      <div class="quick">
        <div class="card">
          <div class="card-header"><h3>Buscar Minhas Solicitações</h3></div>
        ...
        <div class="card">
          ...
          <div class="steps">
            <div class="lane"></div>
            <div class="step"><div class="num">1</div><div class="body"><h5>Abra o chamado</h5><p>Informe local, categoria, prioridade e descreva o problema.</p></div></div>
            <div class="step"><div class="num">2</div><div class="body"><h5>Acompanhe o andamento</h5><p>Veja atualizações do setor e o histórico de respostas.</p></div></div>
            <div class="step"><div class="num">3</div><div class="body"><h5>Concluído e registrado</h5><p>Finalização com rastreabilidade e métricas no painel.</p></div></div>
          </div>
        </div>
      </div>
